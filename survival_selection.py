...
def survival_selection_function(recombined_vector, parent_vector):
    """
    ...
    for i in range(constants.POPULATION_SIZE):
        ...
        if constants.FUNCTION == 'SPHERE':
            ...
            if recombined_adaptation_value <= parent_adaptation_value:
                ...
                survival_adaptation_value[i] = parent_adaptation_value
